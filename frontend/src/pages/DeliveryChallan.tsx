...
export default function DeliveryChallan() {
  ...
  async function handleShareWhatsApp(challan: any) {
    ...
    try {
      ...
      // screen the challan's 860px design width collapses to fit, squishing the
      ...
      // A single page sized to fit the whole challan, instead of slicing one tall
      ...
      // A delivery challan is meant to read as one document, so it always renders as one page.
